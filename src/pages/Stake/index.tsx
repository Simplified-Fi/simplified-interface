      ...
      <AppBody>
        ...
        <AutoColumn gap="lg">
          <CROInputField
            ...
            currencyLogoUrl="https://ipfs.io/ipfs/QmRKe8herb831MnmuN7tB2mTdVcg4cq8mF5pUWW6F2iF3c?filename=deFiSwap-avatar-192px.png"
          />
          ...
          >
            {lessThanMinimumStake ? (
              <Text fontWeight={500} fontSize={16}>
                Your ZERO DeFi Yield multiplier will be 0 if you stake less than 1000 CRO
              </Text>
            ) : (
